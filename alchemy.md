...
## 해독제 (Antidotes)
독을 지닌 생명체의 독에 대한 해독제는 해당 생물의 독을 구성 요소로 사용하여 양조할 수 있습니다. 해독제의 효능은 독의 강도에 따라 결정됩니다. d6 독소 공격은 효능 1 해독제를 필요로 하며, d8 독소 공격은 효능 2 해독제를 필요로 합니다. 이와 같은 방식으로 계속해서 증가합니다. 전투 전에 해독제를 섭취하면 해당 캐릭터는 그 생물이 가하는 독 주입에 면역이 됩니다.
...
## 기초 (Basics)
독소 주사위는 독성 물질로 인한 피해를 나타냅니다. TD는 PC가 독 공격을 받고 건강 내성굴림에 실패할 때 발생합니다. 독소 공격은 '독소'로 표시됩니다. 예를 들어, 피해 표기가 'd6 독소'인 공격은 대상이 d6 TD에 대한 건강 대항 굴림을 해야 합니다.
...
독소가 강력할수록 저항하기 어렵습니다. 영향을 받은 PC는 목록에 표시된 TD 크기보다 10을 더한 값에 대한 건강 내성굴림을 해야 합니다.  

**예시:** *d6 독소 공격은 16을 초과하는 건강 내성굴림을 요구합니다. d10 독소 공격은 20을 초과하는 건강 내성굴림을 요구합니다. 독에 대한 내성굴림은 같은 방식으로 진행됩니다.*
...
한 PC는 한 번에 하나의 TD만 가지고 있습니다. 새로운 독소 공격에 대한 세이브 실패는 현재 TD가 새로운 공격에서 나타내는 크기보다 작을 경우에만 PC의 TD 크기를 증가시킵니다.  

**예시:** *메이건은 d8 독소 주사위에 영향을 받았습니다. 메이건은 d6 독소 공격을 받아 건강 내성굴림에 실패했습니다. 하지만 메이건의 TD는 연계 주사위 중에서 d6보다 큰 d8이기 때문에 주사위 크기가 증가하지 않습니다.*
...
이 시스템은 방사능 주사위와 질병 주사위를 별도로 포함하도록 확장할 수 있습니다. 이 깊고 음흉한 질병에 대해서는 PC가 하루에 한 번씩 주사위를 굴리도록 하되, 자신의 능력 방어도에 직접적인 피해를 입게 허용하면 됩니다. 방사능 질병은 건강을 약화시킬 수 있고, 질병은 심판이 생각하는 적합한 속성을 감소시킬 수 있습니다. 
